...
Servo left_hand_servo;  // servo control object
Servo right_finger_servo; 
...
void loop()
{
 ...
 // right_finger_servo.write(90);

  delay(1000); 

  left_hand_servo.write(108); 
 // right_finger_servo.write(108); 
